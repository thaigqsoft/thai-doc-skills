...
![เทียบผลลัพธ์: ซ้าย = ตัดบรรทัดผิดแบบทั่วไป, ขวา = ตัดถูกต้องด้วย thai-docx](thai-docx/docs/comparison.png)

> ซ้าย = เครื่องมือทั่วไป (ไทยตัดบรรทัดผิดกลางคำ) · ขวา = thai-docx/thai-pdf (ตัดถูกตำแหน่ง เต็มบรรทัดสวยงาม)
